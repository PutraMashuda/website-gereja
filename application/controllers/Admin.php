...
class Admin extends CI_Controller
{
    ...
    public function edit_galeri($kode = 0)
    {
    ...
    public function hapus_galeri($kode = 0)
    {
    ...
    public function tambah_ekstrakulikuler()
    {
    ...
    public function edit_ekstrakulikuler($kode = 0)
    {
    ...
    public function hapus_ekstrakulikuler($kode = 0)
    {
    ...
    public function edit_mapel($kode = 0)
    {
    ...
    public function hapus_mapel($kode = 0)
    {
    ...
    public function simpan_guru()
    {
        ...
        if ($nama = '') {} else {
            $config['upload_path'] = './assets_user';
    ...
    public function hapus_guru($kode = 0)
    {
    ...
    public function edit_guru($kode = 0)
    {
    ...
    public function hapus_siswa_i($kode = 0)
    {
    ...
    public function edit_siswa_i($kode = 0)
    {
    ...
    public function update_siswa_i()
    {
        $data = array(
    ...
    public function edit_siswa_ii($kode = 0)
    {
        $row = $this->admin_model->edit_siswa("where siswa.`id_siswa`  = '$kode'")->result_array();
    ...
    public function update_siswa_ii()
    {
        $data = array(
            'id_siswa' => $this->input->post('id_siswa'),
            'nis' => $this->input->post('nis'),
    ...
    public function edit_siswa_iii($kode = 0)
    {
        $row = $this->admin_model->edit_siswa("where siswa.`id_siswa`  = '$kode'")->result_array();
    ...
    public function update_siswa_iii()
    {
        $data = array(
            'id_siswa' => $this->input->post('id_siswa'),
            'nis' => $this->input->post('nis'),
    ...
    public function detail_artikel($kode = 0)
    {
    ...
    public function hapus_artikel($kode = 0)
    {
    ...
    public function edit_artikel($kode = 0)
    {
        $row = $this->admin_model->edit_artikel("where artikel.`id_artikel`  = '$kode'")->result_array();
    ...
    public function detail_profil($kode = 0)
    {
    ...
    public function hapus_profil($kode = 0)
    {
