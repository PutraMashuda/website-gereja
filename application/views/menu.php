<nav class="navbar navbar-expand-sm navbar-default">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./"><img src="<?php echo base_url() ?>images/logo mekar2.png" alt="Logo"
                width="50"></a>
        <a class="navbar-brand hidden" href="./"><img src="<?php echo base_url() ?>images/logo mekar2.png"
                alt="Logo"></a>
    </div>
    ...
    <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li>
                <a href="<?php echo base_url() ?>admin/ekstrakulikuler"> <i class="menu-icon fa fa-bar-chart"></i>Jadwal
                    Ibadah </a>
            </li>
            <li>
                <a href="<?php echo base_url() ?>admin/mapel"> <i class="menu-icon fa fa-book"></i>Anggota dan
                    Pengurus</a>
            </li>
            <li>
            ...
            <li>
                <a href="<?php echo base_url() ?>liturgi"> <i class="menu-icon fa fa-user"></i>Liturgi </a>
            </li>
            ...
            <li>
                <a href="<?php echo base_url() ?>logout"> <i class="menu-icon fa fa-share"></i>Logout </a>
            </li>
        </ul>
    </div><!-- /.navbar-collapse -->
</nav>