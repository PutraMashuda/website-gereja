					...
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-12 col-md-12">
							...
							<div class="container text-center">
								...
								<a class="btn btn-dark mt-3 mb-3 btn-lg" style="width: 200px" href="<?php echo base_url('user') ?>" role="button">Home</a><br>

								<a class="btn btn-dark mt-3 mb-3 btn-lg" style="width: 200px" href="<?php echo base_url('user/galeri') ?>" role="button">Video</a><br>

								<a class="btn btn-dark mt-3 mb-3 btn-lg" style="width: 200px" href="<?php echo base_url('user/jadwal') ?>" role="button">Jadwal Ibadah</a><br>

								<a class="btn btn-dark mt-3 mb-3 btn-lg" style="width: 200px" href="<?php echo base_url('user/guru') ?>" role="button">Warta Jemaat</a><br>

								<a class="btn btn-dark mt-3 mb-3 btn-lg" style="width: 200px" href="<?php echo base_url('dashboard') ?>" role="button">Liturgi</a><br>

								<a class="btn btn-danger mt-3 mb-3 btn-lg" style="width: 200px" href="<?php echo base_url('login') ?>" role="button">Login Admin</a>
