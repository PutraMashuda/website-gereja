                        ...
                        <!-- <form action="<?php echo base_url()?>admin/simpan_guru" method="post" enctype="multipart/form-data" class="form-horizontal"> -->
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="nip" placeholder="Nama" class="form-control">
                                </div>
                              </div>
                              ...
                              <!-- <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Tema</label>
                                </div>
                                <div class="col-12 col-md-9">
                              ...
                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="file-input" class=" form-control-label">Tema</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="file" id="file-input" name="nama" class="form-control-file">
                                </div>
                              </div>
